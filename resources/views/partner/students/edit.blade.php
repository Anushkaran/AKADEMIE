                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{route('partner.students.index')}}">{{__('labels.list',['name' => trans_choice('labels.student',2)])}}</a>
                                    </li>
            ...
            <div class="content-body">
                ...
                <div class="row">
                    <div class="col-md-6 card">
                        ...
                        <div class="card-body">
                            <form class="add-new-record  pt-0" method="post" action="{{route('partner.students.update',$student->id)}}">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="modal-body flex-grow-1">
                                    ...
                                    <a href="{{route('partner.students.index')}}"  class="btn btn-outline-secondary">{{__('actions.cancel')}}</a>
                                </div>
                            </form>
