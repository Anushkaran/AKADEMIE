                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="myModalLabel110">{{trans_choice('actions.add-new',['name' => trans_choice('labels.student',1)])}}</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    <form action="{{route('partner.evaluations.students.attach',$ev->id)}}" id="attach-students-form" method="post">
                                        @csrf
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.select2').select2({
                ...
                ajax: {
                    delay: 250,
                    url: '{{route('partner.students.index')}}',
                    dataType: 'json',
        ...
        const removeStudent = (id,student) => {
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    f.setAttribute('action',`/partner/evaluations/${id}/students/${student}`);
