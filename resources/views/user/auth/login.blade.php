                    ...
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h1 class="card-title font-weight-bold mb-1">{{__('messages.access_type',['name' => trans_choice('labels.user',2)])}}</h1>
                                ...
                                <form class="auth-login-form mt-2" action="{{route('login')}}" method="POST">
                                    ...
                                    <div class="form-group">
                                        <div class="d-flex justify-content-between">
                                            <label for="login-password">{{__('labels.password')}}</label><a href="{{route('forgot.password.email')}}"><small>{{__('messages.forgot_password')}}</small></a>
                                        </div>
                                ...
                                <a href="{{route('forgot.password.email')}}"><small>{{__('messages.reset_password_text')}} </small></a>
                               {{-- <div class="divider my-2">
