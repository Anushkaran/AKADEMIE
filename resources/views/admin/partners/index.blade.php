                            ...
                            <div class="card-header">
                                <h4 class="card-title">
                                    <a href="{{route('admin.partners.create')}}" class="dt-button create-new btn btn-primary" tabindex="0"
                                        ...
                                        {{trans_choice('actions.add-new',2,['name' => trans_choice('labels.partner',1)])}}
                                    </a>
                                ...
                                <table class="table">
                                    ...
                                    @foreach($partners as $key => $p)
                                        <tr>
                                            ...
                                            <td>
                                                @if($count < 3)
                                                    <a href="{{route('admin.partners.edit',$p->id)}}" class="btn btn-sm btn-outline-warning">
                                                ...
                                                @else
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="{{route('admin.partners.edit',$p->id)}}">
