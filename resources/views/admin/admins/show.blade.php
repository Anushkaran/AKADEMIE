                                        ...
                                        <div class="col-xl-12 col-lg-12 mt-2 ">
                                            <div class="user-info-wrapper">
                                                <div class="d-flex flex-wrap">
                                                    ...
                                                    <p class="card-text mb-0">{{$admin->name}}</p>
                                                </div>
                                                ...
                                                <div class="d-flex flex-wrap">
                                                    ...
                                                    <p class="card-text mb-0">{{$admin->email}}</p>
                                                </div>

                                                <div class="d-flex flex-wrap my-50">
                                                    <div class="user-info-title">
                                                        <i data-feather="star" class="mr-1"></i>
                                                        <span class="card-text user-info-title font-weight-bold mb-0">{{__('labels.role')}}</span>
                                                    </div>
                                                    <p class="card-text mb-0">{{__('labels.roles.'.$admin->role)}}</p>
                                                </div>
                                                <div class="d-flex flex-wrap my-50">
                                                    <div class="user-info-title">
