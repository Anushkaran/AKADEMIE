                                ...
                                <div class="card-body">
                                    <form class="form form-vertical" action="{{route('admin.admins.update',$admin->id)}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label for="password-vertical">{{__('labels.password')}} ({{__('labels.optional')}})</label>
                                                    <input type="password" id="password-vertical" class="form-control @error('password') is-invalid @enderror" name="password" placeholder="{{__('labels.name')}}" />
                                                    @error('password')
                                                    <div class="invalid-feedback">{{$message}}</div>
                                                    @enderror
                                                </div>
