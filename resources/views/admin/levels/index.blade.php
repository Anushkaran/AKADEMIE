            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">{{__('labels.list',['name' => trans_choice('labels.level',2)])}}</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{__('labels.dashboard')}}</a>
                                    </li>
                                    <li class="breadcrumb-item active">{{__('labels.list',['name' => trans_choice('labels.level',2)])}}
                                    </li>
                                </ol>
                            </div>
                        </div>
                            ...
                            <div class="card-header">
                                <h4 class="card-title">
                                    <button class="dt-button create-new btn btn-primary" tabindex="0"
                                        ...
                                        {{trans_choice('actions.add-new',1,['name' => trans_choice('labels.level',1)])}}
                                    </button>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table">
                                    ...
                                    @foreach($levels as $key => $l)
                                        ...
                                        <td>
                                            @if($count < 3)
                                            <a href="{{route('admin.levels.edit',$l->id)}}" class="btn btn-sm btn-outline-warning">
...
{{--                                                        </a>--}}
    ...
    <div class="modal modal-slide-in fade" id="modals-slide-in">
        <div class="modal-dialog sidebar-sm">
            <form class="add-new-record modal-content pt-0" method="post" action="{{route('admin.levels.store')}}">
                @csrf
        ...
        const deleteForm = id => {
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    f.setAttribute('action',`/admin/levels/${id}`);
